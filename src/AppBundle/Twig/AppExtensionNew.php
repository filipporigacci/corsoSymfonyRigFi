...
use Twig_Environment;
    ...
    class AppExtensionNew extends \Twig_Extension
    {
        protected $em;
        protected $stack;
        ...
        public function getFunctions()
        {
            return array(
                ...
                new \Twig_SimpleFunction(
                        //http://twig.sensiolabs.org/doc/2.x/advanced.html#creating-an-extension
                        'stampaTabellaNew1',                   // The first argument passed to the Twig_Filter constructor is the name of the function/filter you will use in templates
                        array($this, 'stampaTabellaNew2'),     // the second one is the PHP callable to associate with it (in this case is the method written by Licari)
        ...
        public function stampaTabellaNew2(Twig_Environment $env, $persone, $campi){
            return $env->render("AppBundle:Template:stampaTabellaNew.html.twig",array('persons' => $persone,'fields'=>$campi));
        }
    }
